  ...
  return <div className="min-h-screen bg-background text-foreground font-inter">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="text-center">
            ...
            <div className="flex justify-center">
              <Button variant="cta-large" size="lg" className="text-lg px-10 py-5" onClick={() => window.open('https://produtos.foguetewill.com.br/pay/mmlab', '_blank')}>
                Garanta Sua Vaga
              </Button>
            </div>
          </div>
          ...
          <div className="max-w-lg mx-auto">
            <Card className="bg-card border-2 border-mm-green shadow-green-glow">
              <CardContent className="p-12 text-center">
                ...
                <Button variant="cta-large" className="w-full text-xl py-6 mb-6 mx-0 my-0 px-0" onClick={() => window.open('https://produtos.foguetewill.com.br/pay/mmlab', '_blank')}> 
                  Garantir Minha Vaga
                </Button>
      ...
      <section className="py-20 bg-gradient-hero">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button variant="cta-large" className="text-xl px-12 py-6 shadow-green-glow hover:shadow-red-glow" onClick={() => window.open('https://produtos.foguetewill.com.br/pay/mmlab', '_blank')}>
